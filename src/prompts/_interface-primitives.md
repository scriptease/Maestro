...
| --------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| "every morning…", "every Friday at 4pm…", "remind me daily…", "kick this off when X happens…", "watch the file…", "when this PR opens…" | Recurring / event-driven automation | Author or update a Cue subscription. Fetch the full schema with `maestro-cli prompts get _maestro-cue` before writing YAML. |
...
| "give me a status report on the fleet", "what ran today?"                                                                               | Cross-fleet summary                 | `maestro-cli director-notes synopsis` or `director-notes history` filtered by day.                                          |
