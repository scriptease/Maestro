...
export const GENERAL_SETTINGS: SearchableSetting[] = [
	...
	},
	{
		...
		description:
			'Configure how to send messages — Enter or Cmd+Enter — and enable Forced Parallel Execution',
		keywords: [
			'enter',
			'send',
			'input',
...
export const NOTIFICATION_SETTINGS: SearchableSetting[] = [
	...
	},
	{
		...
		description:
			'Execute a custom command when all agents and Auto Runs finish and Maestro becomes idle',
		keywords: ['idle', 'finish', 'done', 'complete', 'fleet', 'quiet', 'all done', 'command'],
	},
	{
